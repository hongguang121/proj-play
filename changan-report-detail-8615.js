...
$(document).ready(function(){
    ...
    $(".video-2").change(function(){
        ...
        upload(videoUrl, fd);
        /*var vd = document.getElementById("file-2").files[0];
...
/*var reader = new FileReader();
        ...
        reader.onload=function(e) {
            ...
            $("#" + evt_id).css({"background": "url(" + this.result + ") no-repeat center",
                                 "background-size": "100%"});
            $(".mask").hide();
            $(".approve").stop().animate({
                "bottom":"-2rem"
            ...
            //imgUpload(formData_0, this.result, id);
            //imgUpload(fd, this.result, id);
            ...
            fd.append("file", blob);
            imgUpload(fd, this.result, addPicId);

            imgInfo = delInfo(imgInfo, addPicId);
            imgData = delData(imgData, addPicId);
